...
TEST(TestReadData, BasicAssertions) {
    ...
    arma::vec3 p1{0., 0., 300.};
    arma::vec3 p2{100., 50., 200.};
    arma::vec3 p3{30., -60., -200.};
    arma::vec3 p4{70., -100., -300.};
    double z1 = 100., z2 = -100.;
    arma::vec3 ri{200., 100., 100.};
    arma::vec3 rf{-10., -20., -100.};
    arma::vec3 vi{2. / 3., 1. / 3., -2. / 3.};
    arma::vec3 vf{-10., -20., -100.};
